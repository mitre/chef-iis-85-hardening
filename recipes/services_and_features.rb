...
powershell_script 'V-76687, V-76689' do
  ...
  Add-WebConfigurationProperty -pspath 'MACHINE/WEBROOT/APPHOST'  -filter "system.applicationHost/sites/SiteDefaults/logFile/customFields" -name "." -value @{logFieldName='SERVER_NAME';sourceName='SERVER_NAME';sourceType='ServerVariable'}
